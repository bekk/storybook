...
class CreateableSingleSelectWrapper extends React.Component<
  IProps,
  { selected: ICreateableMultiSelectOption<number>[] }
> {
  ...
  public render() {
    return (
      <CreateableMultiSelect
        ...
        updateSelection={(s: ICreateableMultiSelectOption<number>[]) =>
...
(storiesOf(
  "Components/CreatableMultiSelect",
  module
) as any).addWithJSX("CreatableMultiSelect", () => (
